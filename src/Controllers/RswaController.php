...
namespace edgewizz\rswa\Controllers;
use App\Http\Controllers\Controller;
use App\Models\Media;
use Edgewizz\Edgecontent\Models\ProblemSetQues;
use Edgewizz\Rswa\Models\RswaAns;
use Edgewizz\Rswa\Models\RswaQues;
use Illuminate\Http\Request;

class RswaController extends Controller
{
    //
